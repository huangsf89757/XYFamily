...
| 版本 | 日期 | 变更内容 | 变更人 |
|------|------|----------|--------|
| V1.0.0 | 2026-07-14 | 初始创建，第一版正式发布（重新梳理账号管理模块 PRD，变更记录重置） | CatPaw |
...
> 修改密码（需登录、验证旧密码）归属本模块；密码重置（无需登录、验证码）归属用户认证模块，详见 [02-密码与安全-V1.0.0.md](./02-密码与安全-V1.0.0.md)。
...
|------|--------|----------|-----------|--------|
| 01 | 个人信息管理 | [01-个人信息管理-V1.0.0.md](./01-个人信息管理-V1.0.0.md) | 2 | P0 |
| 02 | 密码与安全 | [02-密码与安全-V1.0.0.md](./02-密码与安全-V1.0.0.md) | 1 | P0 |
| 03 | 账号生命周期 | [03-账号生命周期-V1.0.0.md](./03-账号生命周期-V1.0.0.md) | 2 | P0 |
| 04 | 第三方身份绑定 | [04-第三方身份绑定-V1.0.0.md](./04-第三方身份绑定-V1.0.0.md) | 2 | P2（延后） |
...
| 个人信息管理 | [01-个人信息管理-V1.0.0.md](./01-个人信息管理-V1.0.0.md) | 个人信息查看与修改 |
| 密码与安全 | [02-密码与安全-V1.0.0.md](./02-密码与安全-V1.0.0.md) | 已登录修改密码 |
| 账号生命周期 | [03-账号生命周期-V1.0.0.md](./03-账号生命周期-V1.0.0.md) | 注销与恢复 |
| 第三方身份绑定 | [04-第三方身份绑定-V1.0.0.md](./04-第三方身份绑定-V1.0.0.md) | 第三方账号绑定 / 解绑 |
| 用户认证模块 | [../01-用户认证模块/README.md](../01-用户认证模块/README.md) | 注册、登录、Token、密码重置（职责边界区分） |
| 审计日志模块 | [../09-审计日志模块/README.md](../09-审计日志模块/README.md) | 操作审计日志 |
| 非功能需求 | [../08-非功能需求/README.md](../08-非功能需求/README.md) | 安全 / 性能等全局约束 |
