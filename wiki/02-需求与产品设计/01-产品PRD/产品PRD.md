...
- **想快速了解全貌**：直接阅读 [多租户底座（完整 PRD）](./01-多租户底座/多租户底座.md)，其中合并了全部功能模块、非功能需求、业务流程与风险评估。
- **关注单个模块**：从下方[模块导航](#模块导航)进入对应模块文档，每个模块文档下还包含更细粒度的子功能需求（V1.0.0）。
- **了解需求由来**：先看 [需求背景与目标](./01-多租户底座/01-需求背景与目标)。
...
| 序号 | 模块 | 文档 | 说明 |
|------|------|------|------|
| - | 需求背景与目标 | [需求背景与目标](./01-多租户底座/01-需求背景与目标) | 需求来源、业务价值、目标用户、用户故事 |
| - | 完整 PRD | [多租户底座](./01-多租户底座/多租户底座.md) | 合并全部 8 大模块的完整需求文档 |
...
| 08 | 非功能需求 | [非功能需求](./01-多租户底座/08-非功能需求/非功能需求.md) | 性能、安全、兼容性、可扩展性 |
