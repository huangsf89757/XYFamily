...
### 02-插件管理（Stage 2 · 入口占位）

业务工具插件化接入能力的 PRD 入口占位，待 Stage 1 多租户底座上线稳定后细化。

| 序号 | 模块 | 文档 | 说明 |
|------|------|------|------|
| - | 需求背景与方向 | [插件管理](./02-插件管理/插件管理.md) | 插件接入框架 / 插件市场 / 插件隔离与鉴权（草案） |

### 03-生态扩展（Stage 3 · 入口占位）

平台能力对外开放与商业化的延展阶段 PRD 入口占位，待 Stage 1 多租户底座上线稳定后细化。

| 序号 | 模块 | 文档 | 说明 |
|------|------|------|------|
| - | 需求背景与方向 | [生态扩展](./03-生态扩展/生态扩展.md) | 开放平台 / 商业化 / 跨组织协作（草案） |
