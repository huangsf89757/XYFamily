...
PRD 权限管理模块（[权限管理模块 PRD](../../02-需求与产品设计/01-产品PRD/01-多租户底座/06-权限管理模块/权限管理模块.md)）要求：
...
权限继承为**二维**（PRD [04-权限继承](../../02-需求与产品设计/01-产品PRD/01-多租户底座/06-权限管理模块/04-权限继承.md)）：
...
> 命中率目标 ≥ 95%（NFR-PERF-008，详见 [缓存设计方案](../../README.md)）。
