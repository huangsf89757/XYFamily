...
- [ADR架构决策记录](../../05-架构与方案设计/01-基座/02-ADR架构决策记录.md) — 共享术语：多租户、审计、权限（置信度 0.75）
- [多租户底座](../../04-需求与产品设计/01-产品PRD/01-多租户底座/多租户底座.md) — 共享术语：多租户、审计、权限（置信度 0.75）
- [超级管理员模块](../../04-需求与产品设计/01-产品PRD/01-多租户底座/07-超级管理员模块/超级管理员模块.md) — 共享术语：多租户、审计、权限（置信度 0.75）
