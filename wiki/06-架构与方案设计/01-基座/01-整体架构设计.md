...
> XYFamily 多租户账号权限底座整体技术架构。本文档是「06-架构与方案设计」的 **P1 基座文档**，基于产品 PRD（多租户底座 V1.0.0）重新梳理，定义技术栈、分层架构、模块边界、部署拓扑、请求处理链路总览与关键设计约束基线，为后续核心域方案（多租户隔离 / RBAC / JWT）、数据模型、接口契约、链路实现与横切专项提供统一基础。
